...
class AppDelegate: UIResponder, UIApplicationDelegate {
  let tagForCustomLoader : Int = 1216
    ...
    func showCustomLoaderForBottom(_ senderController: UIViewController) {
        ...
        let winodBoud : CGRect! = CGRect(x: 0.0, y: 0.0, width: UIScreen.main.bounds.size.width, height: UIScreen.main.bounds.size.height)
    ...
    func checkForCustomLoader(_ senderController: UIViewController) {
